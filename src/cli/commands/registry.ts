...
import { routingExtractSchema } from "./routing-extract.cmd.js";
import { routingSelectTierSchema } from "./routing-select-tier.cmd.js";
...
schemaRegistry.set("routing:extract", routingExtractSchema);
schemaRegistry.set("routing:select-tier", routingSelectTierSchema);
