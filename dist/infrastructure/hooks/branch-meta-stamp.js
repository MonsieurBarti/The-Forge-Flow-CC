...
export function readLocalStamp(tffDir) {
...
export function writeLocalStamp(tffDir, meta) {
    const stampPath = path.join(tffDir, STAMP_FILE);
    const stamp = BranchMetaSchema.parse({ ...meta, restoredAt: new Date().toISOString() });
    writeFileSync(stampPath, JSON.stringify(stamp, null, 2));
}
export function writeSyntheticStamp(tffDir, codeBranch) {
...
//# sourceMappingURL=branch-meta-stamp.js.map