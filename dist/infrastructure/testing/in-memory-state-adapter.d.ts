...
export declare class InMemoryStateAdapter implements DatabaseInit, ProjectStore, MilestoneStore, SliceStore, TaskStore, DependencyStore, SessionStore, ReviewStore {
    private project;
    private milestones;
    private slices;
    private tasks;
...
//# sourceMappingURL=in-memory-state-adapter.d.ts.map