...
import { createClosableStateStores, createClosableStateStoresUnchecked, createStateStores, createStateStoresUnchecked, } from "../infrastructure/adapters/sqlite/create-state-stores.js";
import { writeLocalStamp, writeSyntheticStamp } from "../infrastructure/hooks/branch-meta-stamp.js";
async function handleMismatch(error) {
...
export async function withBranchGuard(fn, opts) {
    try {
...
export async function withClosableBranchGuard(fn, opts) {
    try {
...
//# sourceMappingURL=with-branch-guard.js.map