...
export { type DetectDirectEditDeps, type DirectEditResult, type DirectEditWarning, detectDirectEdit, } from "./guard/detect-direct-edit.js";
export { type DetectSpecEditResult, detectSpecEdit, type SpecEditWarning, } from "./guard/detect-spec-edit.js";
export { generateRecoveryHint, getPrerequisite, getRequiredStatus, getSupportedOperations, isValidOperation, type OperationPrerequisite, type WorkflowOperation, } from "./guard/operation-prerequisites.js";
export { assertOperationAllowed, getOperationPrerequisite, isOperationAllowed, OperationBlockedError, type ValidationResult, validateOperation, } from "./guard/validate-operation.js";
