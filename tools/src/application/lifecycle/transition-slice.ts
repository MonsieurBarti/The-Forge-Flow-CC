...
interface TransitionInput { slice: Slice; beadId: string; targetStatus: SliceStatus; }
interface TransitionDeps { beadStore: BeadStore; }
interface TransitionOutput { slice: Slice; events: DomainEvent[]; }

export const transitionSliceUseCase = async (
  input: TransitionInput, deps: TransitionDeps,
