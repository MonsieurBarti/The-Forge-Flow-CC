		...
		it("allows discussing → researching transition", async () => {
			...
			mockTransitionSliceUseCase.mockResolvedValue({
				...
				data: {
					...
					events: [
						{
							type: "SLICE_TRANSITIONED",
							payload: { sliceId: "M01-S01", from: "discussing", to: "researching" },
						},
					],
				},
			});
			...
			mockTransitionSliceUseCase.mockResolvedValue({
				...
				data: {
					...
					events: [
						{
							type: "SLICE_TRANSITIONED",
							payload: { sliceId: "M01-S01", from: "researching", to: "planning" },
						},
					],
				},
			});
			...
			mockTransitionSliceUseCase.mockResolvedValue({
				...
				data: {
					...
					events: [
						{
							type: "SLICE_TRANSITIONED",
							payload: { sliceId: "M01-S01", from: "planning", to: "executing" },
						},
					],
				},
			});
