...
import { type GenerateReminderDeps, generateReminder } from '../../../src/application/session/generate-reminder.js';
...
function createMockDeps(
  ...
  const mockTaskStore: TaskStore = {
    createTask: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    getTask: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    listTasks: () => Ok(tasks) as MockResult<Task[]>,
    updateTask: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    claimTask: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    closeTask: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    listReadyTasks: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    listStaleClaims: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    getExecutorsForSlice: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
  };

  const mockDependencyStore: DependencyStore = {
    addDependency: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
    removeDependency: () => ({ ok: false, error: { code: 'NOT_IMPLEMENTED', message: 'Mock' } as DomainError }),
