...
import { sliceTransitionCmd, sliceTransitionSchema } from "../../../../src/cli/commands/slice-transition.cmd.js";
...
describe("sliceTransitionSchema — flag parsing", () => {
	it("accepts a display label (M01-S01)", () => {
		const result = parseFlags(["--slice-id", "M01-S01", "--status", "planning"], sliceTransitionSchema);
